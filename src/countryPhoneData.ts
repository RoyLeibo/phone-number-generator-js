...
// Data from https://github.com/AfterShip/phone
export const countryPhoneDataArray: CountryPhoneData[] = [
  {
    alpha2: "US",
    alpha3: "USA",
    country_code: "1",
  ...
  },
  {
    ...
    mobile_begin_with: ["351"], // Same for mobile and landlines
    phone_number_lengths: [10],
  },
  {
    alpha2: "AM",
